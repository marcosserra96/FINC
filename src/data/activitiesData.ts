...
const memoriaEnergia: MemoryActivityConfig = {
  ...
  pairs: [
    ...
    { id: 'p3', icon: 'ac', label: 'Ar-condicionado', tip: 'Portas e janelas fechadas ajudam o ambiente a esfriar mais rápido.' },
    { id: 'p4', icon: 'fridge', label: 'Geladeira', tip: 'Um espaço livre atrás ajuda o motor a trabalhar de forma mais tranquila.' },
    { id: 'p5', icon: 'tv', label: 'Televisão', tip: 'Desligar de vez, e não só deixar em espera, evita desperdício.' },
    { id: 'p6', icon: 'iron', label: 'Ferro elétrico', tip: 'Juntar as roupas para passar de uma vez costuma ser mais eficiente.' }
  ]
};
